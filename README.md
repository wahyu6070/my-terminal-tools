...
```bash
pkg update -y && pkg install curl wget -y && curl -sL [https://raw.githubusercontent.com/wahyu6070/my-terminal-tools/main/start.sh](https://raw.githubusercontent.com/wahyu6070/my-terminal-tools/main/start.sh) -o start.sh && bash start.sh
